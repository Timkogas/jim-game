...
class GameActions {
  ...
  public build(): void {
    ...
    const bg = this._scene.add.sprite(this._scene.platform.getBounds().centerX, this._scene.platform.getBounds().bottom + 280, 'bg').setOrigin(0.5, 1);
    bg.setDisplaySize(this._scene.platform.body.width + 800, height + 380)
